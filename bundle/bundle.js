...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.resoltQustion = undefined;
	exports.renderQuestionPage = renderQuestionPage;
	...
	function renderQuestionPage(curentUser) {
		...
		var resoltButton = _createElement.elem.getLink('endTest');
		resoltButton.addEventListener('click', endTest);

		for (var i = 1; i < 11; i++) {
			var button = _createElement.elem.getLink('question' + i);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<div id=\"nav\">\n		<h2>Список вопросов</h2>\n		<button id=\"question1\">1</button>\n		<button id=\"question2\">2</button>\n		<button id=\"question3\">3</button>\n		<button id=\"question4\">4</button>\n		<button id=\"question5\">5</button>\n		<button id=\"question6\">6</button>\n		<button id=\"question7\">7</button>\n		<button id=\"question8\">8</button>\n		<button id=\"question9\">9</button>\n		<button id=\"question10\">10</button>\n		<hr>\n</div>\n<div id=\"question\">\n	\n</div>\n<div>\n	<hr>\n	<button id=\"endTest\">Закончить тест</button>\n</div>";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<h1>"
	    ...
	    + "</h1>\n		\n<form id=\"options\" action=\"\">\n		<ul id=\"answers\"></ul>\n		<button type =\"submit\" id=\"submit\">Подтвердить ответ</button>\n</form>";
	},"useData":true});
...
/***/ function(module, exports) {
	...
	var elem = exports.elem = {
		...
		createAnswer: function createAnswer(parent, data, name, value) {
			...
			for (var i = 0; i < data.curentCheck.length; i++) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function renderUser(user) {
		...
		var container = _createElement.elem.getLink('container');
		container.innerHTML = (0, _user2.default)(curentUser);

		var start = _createElement.elem.getLink("start");
		start.addEventListener('click', _render.renderQuestionPage);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div>\n	<h1>Привет "
	    ...
	    + "</h1>\n	<p>Мы приветствуем Вас на вашей странице</p>		\n	<h2>Нажмите \"Старт\" для начала тестирования</h2>\n	\n	<button id=\"start\">Старт</button>\n	\n</div>";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<div>\n	<form id=\"loginForm\" action=\"\">\n		<ul>\n			<li>\n				<label for=\"login\">Login</label>\n				<input type=\"login\" name=\"login\" id=\"login\" required=\"true\" placeholder=\"your login\" class=\"box\">\n			</li>\n			<li>\n				<label for=\"password\">Password</label>\n				<input type=\"password\" name=\"password\" id=\"password\" required=\"true\" placeholder=\"your password\" class=\"box\">\n			</li>\n			<li>\n				<input type=\"submit\" name=\"submit\" id=\"submit\">\n			</li>\n		</ul>\n	</form>\n</div>";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function renderAdmin(user) {
		...
		var container = _createElement.elem.getLink('container');
		container.innerHTML = (0, _admin2.default)(curentUser);

		var showAddUserForm = _createElement.elem.getLink('addNewUser');
		showAddUserForm.addEventListener('click', addUserForm);

		var showQuestionForm = _createElement.elem.getLink('showQuestionForm');
